...
public class BoardServiceTests {
	...
	public void testExist() {
		// 객체 생성 유무 판단용 테스트
		log.info(service); // 인터페이스를 필드로 생성하였는데 서비스 객체를 실행하면 impl이 붙은 클래스가 실행된다.
	...
	public void testUpdate() {
		...
		log.info("서비스에서 수정메사드 결과 : " + service.modify(board)); // boolean
	}
	
	@Test
	public void testDelete() {
		
		log.info("삭제된 결과 : " + service.remove(27L));
